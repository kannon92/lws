...
type LeaderWorkerSetSpecApplyConfiguration struct {
	...
	HeadlessServicePerLeaderWorker *bool                                   `json:"headlessServicePerLeaderWorker,omitempty"`
}
...
// WithHeadlessServicePerLeaderWorker sets the HeadlessServicePerLeaderWorker field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the HeadlessServicePerLeaderWorker field is set to the value of the last call.
func (b *LeaderWorkerSetSpecApplyConfiguration) WithHeadlessServicePerLeaderWorker(value bool) *LeaderWorkerSetSpecApplyConfiguration {
	b.HeadlessServicePerLeaderWorker = &value
	return b
}
